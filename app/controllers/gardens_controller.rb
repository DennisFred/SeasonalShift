class GardensController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @garden.update(garden_params)
        format.html { redirect_to @garden, notice: "Garden was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to gardens_path, notice: "Garden was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_garden
      @garden = Garden.find(params.expect(:id))
    end
